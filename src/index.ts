...
async function renderHome(env: Env): Promise<Response> {
  ...
  const updatesUrl = "/updates"; // или якорь, если есть
  
  const body = `
    <section class="home">
      <div class="home-hero">
        <div class="home-top">
          <div class="home-badge">SREDA • infrastructure</div>
          ...
          <p class="home-status">SREDA находится в разработке. Новые инструменты будут запускаться постепенно.</p>
        </div>
      </div>
